...
\textbf{OPEX base mensual (calibrado MVP):} \$29.577.542 COP (sin incluir CAC variable) \\
\textbf{Ruta de rentabilidad:} seguimiento anual en hoja \textit{Ruta Rentabilidad} (años 1 a 10) \\
\textbf{Modelo de Monetización Recomendado:} Híbrido (Comisiones + Suscripción Premium + B2B)
...
\textbf{OPEX base (sin CAC variable):} \$29.577.542 COP/mes - \$354.930.504 COP/año
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Evolución a planes B2B escalonados por valor entregado
    \end{itemize}
    \item \textbf{Gobierno de uso IA (defensa de margen):}
    \begin{itemize}
        \item Usuarios free: 20 requests/mes incluidos
        \item Política de uso justo y límites de consumo para evitar abuso
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Crecimiento nuevos usuarios: 5.00\%/mes
        \item Conversión inicial free a premium: 10.00\%
        \item Churn free: 12.00\%/mes
        \item Churn premium: 7.00\%/mes
    \end{itemize}
    ...
    \begin{itemize}
        \item Precio suscripción premium: COP 32,900/mes
        \item Ticket promedio por transacción: COP 380,000
        \item Tasa de comisión: 5.5\%
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Usuario Free (unit economics actualizado):}
    \begin{itemize}
        \item Ingresos promedio/mes: \$10.450 COP
        \item Costos variables/mes: \$6.145 COP
        \item Margen bruto: \$4.305 COP (41.2\%)
    \end{itemize}
    \item \textbf{Usuario Premium (unit economics actualizado):}
    \begin{itemize}
        \item Ingresos promedio/mes: \$74.700 COP
        \item Costos variables/mes: \$22.660 COP
        \item Margen bruto: \$52.040 COP (69.7\%)
    \end{itemize}
\end{itemize}

\textbf{Conclusión:} MARGEN POSITIVO en ambos segmentos. Premium continúa siendo el principal motor de contribución.
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/pyg-12m.pdf}
\caption{Estado de resultados proyectado — 12 meses}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/pyg-36m.pdf}
\caption{Estado de resultados proyectado — 36 meses}
\end{figure}

Con base en el escenario calibrado del modelo (crecimiento 5\% mensual y estructura MVP):
...
\begin{itemize}
    \item \textbf{Año 1:} etapa de validación con EBITDA y utilidad neta negativos (normal para MVP en Colombia).
    \item \textbf{Año 2:} convergencia hacia punto de equilibrio operativo.
    \item \textbf{Año 3:} expansión con mayor absorción de costos fijos y mejora de margen.
\end{itemize}

\textbf{Análisis:} La decisión no se sustenta en un único mes de break-even, sino en la trayectoria anual de rentabilidad ya modelada.
...
\subsection{Indicadores financieros consolidados}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/indicadores-financieros.pdf}
\caption{Indicadores financieros (VPN, TIR, márgenes, payback)}
\end{figure}

\subsection{Ruta de rentabilidad anual}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/ruta-rentabilidad.pdf}
\caption{Ruta de rentabilidad por año y primer año con utilidad neta positiva}
\end{figure}

\subsection{Flujo de caja del proyecto (evaluación académica)}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/fc-proyecto.pdf}
\caption{Flujo de caja del proyecto — sin inflación, financiación ni impuestos}
\end{figure}

\subsection{Flujo de caja de la empresa (evaluación académica)}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figures/fc-empresa.pdf}
...
\begin{itemize}
    \item \textbf{Escenario Base:} crecimiento moderado y control de costos para sostener caja.
    \item \textbf{Escenario Conservador:} presión temporal sobre caja por menor conversión y mayor churn.
    \item \textbf{Escenario Optimista:} aceleración de margen por mejor mezcla premium y B2B.
\end{itemize}

\textbf{Punto Crítico:} mantener crecimiento de ingresos por encima del crecimiento de OPEX y CAC.
...
\begin{itemize}
    \item \textbf{Limitar Uso:} 20 requests/mes free con política de uso justo
    \item \textbf{Optimizar Conversión:} elevar migración a premium con onboarding y beneficios percibidos
    \item \textbf{Escalar B2B:} foco en planes de mayor valor por cliente
    \item \textbf{Híbrido (Recomendado):} comisiones + premium + B2B con control de costos IA
\end{itemize}
...
\begin{itemize}
    \item \textbf{Short-term (3 meses):} validar adquisición, conversión y retención inicial
    \item \textbf{Medium-term (6-12 meses):} mejorar LTV/CAC y consistencia de ingresos recurrentes
    \item \textbf{Long-term (24-36 meses):} consolidar rentabilidad operativa y escalamiento disciplinado
\end{itemize}
