...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/aws_architecture.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/contexto_c4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/contenedores_c4.png}
